...
import IDBServerPlugin.IDBServerPlugin;
...
public class PluginManager {
    ...
    public  Class<?>[] clsType=new Class<?>[]{IDBServerPlugin.class};
    /*
     * 单例
     */
...
public void startAllPlugin(String path,int num)
{
    ...
    for(Entry<String,Class<?>> kv:hashmap.entrySet())
    {
        ...
        if(IDBServerPlugin.class.isAssignableFrom(obj.getClass()))
        {
            IDBServerPlugin pobj=(IDBServerPlugin) obj;
            pobj.start(null);
        }
        }
    }
