 ...
 * 类描述：    真正的线程处理
 * 创建人：jinyu    
 * 创建时间：2017年4月13日 下午10:24:35    
 * 修改人：jinyu    
 * 修改时间：2017年4月13日 下午10:24:35    
 * 修改备注：    
 * @version     
 *     
 */
public class StartThread extends Thread{
    ...
    //线程执行控制
    public StartThread(UDTSocket socket,IRecMsg outRec,UdtProtocol protol)
    {
        this.socket=socket;
        this.rec=outRec;
    ...
    private void processUdtData()
    {
        ...
        //
        ThreadManager.counter_integer.incrementAndGet();
     ...
     try {
        ...
        //正常运行的数据才要
          ...
          ThreadManager.counter_integer.decrementAndGet();
           //
           if(curProtol!=null)
           {
               try
